...
def make_yearly_subset_gridV(yr,runname,pref = 'nemo', dtype = 'grid-V', tdir = 'ukesm_allscen_gridV_vo'):
    ...
    if len(fils) != 12:
        ...
        data_vars = {'vomecrty':(['time_counter', 'depthv','y', 'x'], vo,
                                 {'units': 'm/s',
                                  'long_name':'vomecrty'}),
