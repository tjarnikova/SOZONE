...
varUKESM = 'somxl010'
varTOM = 'mldkz5' #turbocline because we don't have somxl030
dtypeTOM = 'grid_T'
dtypeUKESM = 'MLD'
...
def get_ts_2d(startyr,endyr,scenUKESM,dtypeUKESM,dtypeTOM, baseDirTOM,varUKESM,varTOM):
    ...
    ukesm_latmax = 332#114
    tom_latmax = 332#37
    ukesm_fg = ukesmvar[:,0:ukesm_latmax,:].weighted(ukmesh['area'][0:ukesm_latmax,:]).mean(dim = ['y', 'x'])
    tom_fg = tomvar[:,0:tom_latmax,:].weighted(tommesh['area'][0:tom_latmax,:]).mean(dim = ['y', 'x'])

    ukesm_latmax = 114
    tom_latmax = 37
    ukesm_so = ukesmvar[:,0:ukesm_latmax,:].weighted(ukmesh['area'][0:ukesm_latmax,:]).mean(dim = ['y', 'x'])
    tom_so = tomvar[:,0:tom_latmax,:].weighted(tommesh['area'][0:tom_latmax,:]).mean(dim = ['y', 'x'])
...
get_ts_2d(startyr,endyr,scenUKESM,dtypeUKESM,dtypeTOM, baseDirTOM,varUKESM,varTOM)
