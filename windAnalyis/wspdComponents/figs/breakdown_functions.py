...
def observationData(obs, obs_lon, obs_lat, var, var_lons, var_lats, obsCenter, tmask, missingVal, gammaFlag, lonLim, latLim):
    ...
    # print(total, count, rmse_annual, total_mod, count_mod, rmse_annual_mod)
    ...
    # nc_v.setncattr("missing_value", np.array(1E20,'f'))
    # nc_test_id.variables['test2'][:] = diff_mod

    # nc_v = nc_test_id.createVariable("test3", 'f', ('t','y', 'x'))
    # nc_v.setncattr("missing_value", np.array(1E20,'f'))
    # nc_test_id.variables['test3'][:] = modified_obs

    # nc_v = nc_test_id.createVariable("test4", 'f', ('t','y', 'x'))
    # nc_v.setncattr("missing_value", np.array(1E20,'f'))
    # nc_test_id.variables['test4'][:] = modified_weights
