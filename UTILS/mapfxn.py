...
def plot_southern(fig, ax1, lons, lats, tdat, tvmin, 
    ...
    # mesh = ax1.pcolormesh(tdat, cmap = tcmap, vmin = tvmin, vmax = tvmax,
    #              transform=ccrs.PlateCarree())
    #mesh = ax1.contourf(lons, lats, tdat,transform=ccrs.PlateCarree())
...
#     #plot data according to given levels
#     tlev = np.arange(tvmin,tvmax+intvl,intvl)
#     mesh = ax1.pcolormesh(lons, lats, tdat, tlev, cmap = tcmap, vmin = tvmin, vmax = tvmax,
#                  transform=ccrs.PlateCarree())
#     #mesh = ax1.contourf(lons, lats, tdat,transform=ccrs.PlateCarree())
...
def plot_southern_2(fig, ax1, lons, lats, tdat, tvmin, 
